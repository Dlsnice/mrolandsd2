...
<<<<<<< HEAD
	'form_honeypot'                               => '<strong>' . __( 'Enable Honeypot', 'gravityforms' ) . '</strong>' . __( 'Enable the honeypot to detect spam using multiple techniques.', 'gravityforms' ),
=======
...
<<<<<<< HEAD
	'form_field_display_choices_in_columns'       => '<strong>' . __( 'Display Choices in Columns', 'gravityforms' ) . '</strong>' . __( 'Check this option to display the choices in columns instead of a single column.', 'gravityforms' ),
	'form_field_column_sort_direction'            => '<strong>' . __( 'Column Sort Direction', 'gravityforms' ) . '</strong>' . __( 'Column Sort Direction determines how choices are ordered when displayed in multiple columns: Across fills left to right, then moves to the next row; Down fills top to bottom, then moves to the next column.', 'gravityforms' ),
=======
>>>>>>> f26e4f95b60bfd1cf1147cc07e0ad43a657b7fd6
...
<<<<<<< HEAD
	'form_field_enable_enhanced_ui'               => '<strong>' . __( 'Enable Enhanced UI', 'gravityforms' ) . '</strong>' . sprintf( __( "By selecting this option, the %s jQuery script will be applied to this field, enabling search capabilities to Drop Down fields and a more user-friendly interface for Multi Select fields.", 'gravityforms' ), "<a href='https://harvesthq.github.io/chosen/' target='_blank' title='Chosen'>Chosen<span class=\"screen-reader-text\">" . esc_html__( '(opens in a new tab)', 'gravityforms' ) . "</span>&nbsp;<span class=\"gform-icon gform-icon--external-link\" aria-hidden=\"true\"></span></a>" ),
